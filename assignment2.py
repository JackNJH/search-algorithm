...
neighbors = {
    ...
    (1, 1): [(0, 2), (0, 1), (1, 0), (2, 1), (1, 2)],
    (1, 2): [(0, 3), (0, 2), (1, 1), (2, 3), (1, 3)],
    (1, 3): [(0, 4), (0, 3), (1, 2), (2, 3), (1, 4)],
    (1, 4): [(0, 5), (0, 4), (1, 3), (2, 5), (1, 5)],
    ...
    (3, 3): [(2, 4), (2, 3), (3, 2), (4, 3)],       # (4,4) removed
    (3, 4): [(2, 5), (2, 4), (3, 3), (4, 5), (3, 5)],  # (4,4) removed
    ...
    (4, 3): [(3, 4), (3, 3), (4, 2), (5, 3), (5, 4)],   # (4,4) removed
    (4, 4): [(3, 5), (3, 4), (4, 3), (5, 4), (5, 5)],
    (4, 5): [(3, 6), (3, 5), (5, 5), (5, 6)],            # (4,4) removed
    (4, 6): [(3, 7), (3, 6), (4, 5), (5, 6), (5, 7)],    # (4,7 removed)
    (4, 7): [(3, 8), (3, 7), (5, 7), (5, 8), (4, 8)],    # (4,6) removed
    (4, 8): [(3, 9), (3, 8), (5, 8), (5, 9), (4, 9)],
    (4, 9): [(3, 9), (3, 8), (4, 8), (5, 9)],

    (5, 0): [(4, 1), (4, 0), (5, 1)],
    (5, 1): [(4, 2), (4, 1), (5, 0), (5, 2)],
    (5, 2): [(4, 3), (4, 2), (5, 1), (5, 3)],
    (5, 3): [(4, 3), (5, 2), (5, 4)],                    # (4,4) removed
    (5, 4): [(4, 5), (5, 3), (5, 5)],                    # (4,4) removed
    (5, 5): [(4, 5), (5, 4), (5, 6)],
    (5, 6): [(5, 5), (5, 7)],                             # (4,6) removed
    (5, 7): [(4, 8), (5, 6), (5, 8)],                    # (4,7) removed
    (5, 8): [(4, 9), (4, 8), (5, 7), (5, 9)],
    (5, 9): [(4, 9), (5, 8)],
}
